...
namespace AlumnoEjemplos.LucasTest
{
    ...
    /// </summary>
    public class SurvivalCamara : TgcCamera
    {
        ...
        public bool mouseCapturado = false;
        ...
        readonly Vector3 DEFAULT_UP_VECTOR = new Vector3(0.0f, 1.0f, 1.0f);
        ...
        public void capturarMouse(bool swCapturar)
        {
            mouseCapturado = swCapturar;
        }

        public bool getMouseCapturado()
        {
